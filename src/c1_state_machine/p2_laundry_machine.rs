        ...
        match t {
            ClothesAction::Wear => {
                match starting_state{
                    ClothesState::Clean(n) => {if n-1 ==0 {return ClothesState::Tattered} else {return ClothesState::Dirty(n-1)}},
                    ClothesState::Dirty(n) => {if n-1 ==0 {return ClothesState::Tattered} else {return ClothesState::Dirty(n-1)}},
                    ClothesState::Wet(n) => {if n-1 ==0 {return ClothesState::Tattered} else {return ClothesState::Dirty(n-1)}},
                    ClothesState::Tattered => return ClothesState::Tattered,
                }
            },
            ClothesAction::Wash => {
                match starting_state{
                    ClothesState::Clean(n) => {if n-1 ==0 {return ClothesState::Tattered} else {return ClothesState::Wet(n-1)}},
                    ClothesState::Dirty(n) => {if n-1 ==0 {return ClothesState::Tattered} else {return ClothesState::Wet(n-1)}},
                    ClothesState::Wet(n) => {if n-1 ==0 {return ClothesState::Tattered} else {return ClothesState::Wet(n-1)}},
                    ClothesState::Tattered => return ClothesState::Tattered,
                }
            },
            ClothesAction::Dry => {
                match starting_state{
                    ClothesState::Clean(n) => {if n-1 ==0 {return ClothesState::Tattered} else {return ClothesState::Clean(n-1)}},
                    ClothesState::Dirty(n) => {if n-1 ==0 {return ClothesState::Tattered} else {return ClothesState::Dirty(n-1)}},
                    ClothesState::Wet(n) => {if n-1 ==0 {return ClothesState::Tattered} else {return ClothesState::Clean(n-1)}},
                    ClothesState::Tattered => return ClothesState::Tattered,
                }
            },
        }
